...
String? passwordValidation(String? value) {
  if (value!.isEmpty) {
    ...
    return "Password must b greater then 8 characters";
  } else {
    return null;
  }
}
...
// For small alphabtes
String getRandomSmallString(int length) {
...
// for Url Launch
launchFileUrl(String fileLink) async {
  try {
